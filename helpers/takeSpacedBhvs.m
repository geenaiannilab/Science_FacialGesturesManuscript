function obhvOut = takeSpacedBhvs(obhv,minRest,varargin)
...
% else
%     prompt = ([num2str(size(obhv.evScore,1) - removedEvs) ' of ' num2str(size(obhv.evScore,1)) '  events remain -- do you want to continue[y/n]: ']);
%     answer = input(prompt,'s');
% 
%     if strcmpi(answer,'y')
%         obhv.evScore = evSpaced;
%     elseif isempty(answer) | ~strcmpi(answer,'y')
%         disp('NOT altering bhv')
%     end
end
